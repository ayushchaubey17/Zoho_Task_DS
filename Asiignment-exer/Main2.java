...
public class Main2 {
    public static void main(String[] args) {
        ...
        List<String> proteins1 = translator.translate("AUGUUUUCU");
        System.out.println("Proteins for AUGUUUUCU: " + proteins1);


        List<String> proteins2 = translator.translate("AUGUUUUCUUAAAUG");
        System.out.println("Proteins for AUGUUUUCUUAAAUG: " + proteins2);
    }
}
